...
ARjs.Context.prototype.addMarker = function(arMarkerControls){
	...
	console.log('add marker for', arMarkerControls)
	this._arMarkersControls.push(arMarkerControls)
	console.log("add this._arMarkersControls.length " + this._arMarkersControls.length);
}

ARjs.Context.prototype.removeMarker = function(arMarkerControls){
	//console.assert(arMarkerControls instanceof THREEx.ArMarkerControls)
	//console.log('remove marker for', arMarkerControls)
	console.log("arMarkersControls.id ") + arMarkerControls.id;
	console.log("this._arMarkersControls.length " + this._arMarkersControls.length); 
	var index = this._arMarkersControls.indexOf(arMarkerControls);
	console.log("arMarkersControls.indexOf ") + index;
	//console.assert(index !== index )
	arMarkerControls = null;
	this._arMarkersControls.splice(index, 1);
	
	console.log("remove this._arMarkersControls.length " + this._arMarkersControls.length);
}


ARjs.Context.prototype.removeAllMarkers = function(){
	this._arMarkersControls.length = 0;
	this._arMarkersControls = null;
}
