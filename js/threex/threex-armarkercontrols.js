...
ARjs.MarkerControls.prototype.dispose = function(){
	...
	console.log("ARjs.MarkerControls dispose " + _this.context);
	if (_this.context.arController != null)
	{
		_this.context.arController.removeEventListener('getMarker', function(event){
	...
	_this.context.arController = null; 
	_this.object3d = null;
	_this.context.removeMarker(_this)
 	
	
	//_this.context.arController.removeEventListener('getMarker', function());
...
ARjs.MarkerControls.prototype.confidenceLevel = function(){
...
ARjs.MarkerControls.prototype._initArtoolkit = function(){
	...
	function onMarkerFound(event){
		...
		{			
			_this.confidencelevel = event.data.marker.cfPatt;
		} else if( event.data.type === artoolkit.BARCODE_MARKER)
		{
			_this.confidencelevel = event.data.marker.cfMatt;
		}
	}
}
